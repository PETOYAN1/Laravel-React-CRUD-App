...
export const Footer = () => {
  return (
    <footer className="border-t bg-white border-gray-100 pt-32 pb-8 dark:border-slate-900 dark:bg-slate-950 rounded-2xl">
        <div>
                    ...
                    <div className="col-span-8 md:col-span-2 lg:col-span-3">
                        <div className="flex h-full items-center justify-between gap-6 border-b border-white py-6 dark:border-gray-800 md:flex-col md:items-start md:justify-between md:space-y-6 md:border-none md:py-0">
                            <div>
                                ...
                                <Link href="https://tailus.io" className="mt-2 inline-block text-sm">Designed by Tailus in Lubumbashi </Link>
                                </div>
                                <div className="flex gap-6">
                                    <Link to={'/'} target="blank" aria-label="github" className="hover:text-primary dark:hover:text-primaryLight">
                                    ...
                                    <Link to={'/'} target="blank" aria-label="twitter" className="hover:text-primary dark:hover:text-primaryLight">
                                    ...
                                    <Link to={'/'} target="blank" aria-label="medium" className="hover:text-primary dark:hover:text-primaryLight">
                            ...
                            <div className="grid grid-cols-2 gap-6 pb-16 sm:grid-cols-3 md:pl-16">
                                <div>
                                    ...
                                    <ul className="mt-4 list-inside space-y-4">
                                        <li>
                                            <Link to={'/'} className="text-sm duration-100 hover:text-primary dark:hover:text-white">About</Link>
                                        </li>
                                        <li>
                                            <Link to={'/'} className="text-sm duration-100 hover:text-primary dark:hover:text-white">Customers</Link>
                                        </li>
                                        <li>
                                            <Link to={'/'} className="text-sm duration-100 hover:text-primary dark:hover:text-white">Enterprise</Link>
                                        </li>
                                        <li>
                                            <Link to={'/'} className="text-sm duration-100 hover:text-primary dark:hover:text-white">Partners</Link>
                                        </li>
                                        <li>
                                            <Link to={'/'} className="text-sm duration-100 hover:text-primary dark:hover:text-white">Jobs</Link>
                                        </li>
                                    </ul>
                                </div>
                                <div>

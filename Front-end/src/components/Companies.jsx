...
export const Companies = () => {
  return (
    <div className="mt-12 border-y border-gray-100 py-8 text-center bg-white dark:bg-slate-950 rounded-2xl dark:border-slate-800 md:py-12 xl:mt-20 px-10">
        <Link to={'/skills'} className="text-sm font-semibold tracking-wider text-gray-800 dark:text-white">TRUSTED BY YOUR FAVORED TOP TECHS COMPANIES</Link>
